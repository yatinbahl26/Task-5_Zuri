        ...
        <div className='mx-auto max-w-6xl'>
          <div className='container mx-auto flex flex-col sm:flex-row items-center px-4 gap-10 sm:gap-0'>
            <article className='sm:w-[45%] text-center sm:text-left'>
              <h1 className='font-sora text-[2.5rem] lg:text-6xl font-bold leading-none mb-6 text-title-color'>
                Show Them Don’t Just Tell
              </h1>
              <p className='font-xl leading-[140%] text-black/75 font-inter mb-8 lg:mb-12 pr-4'>
                Help your friends and loved ones by creating and sending videos
                on how to get things done on a website.
              </p>
              <Link
                href='https://drive.google.com/file/d/1jaGAofLtwBBKhnsicXGJY8--eCsL4ZQE/view?usp=sharing'
            ...
            <div className='w-full sm:w-[55%] aspect-[1.45/1] sm:aspect-[unset] pb-6 sm:pb-14 lg:pb-[86px] pr-5 sm:pr-8 lg:pr-12 pl-4 sm:pl-9 lg:pl-[52px] pt-5 sm:pt-10 lg:pt-14 relative'>
              <div className='w-2/5 aspect-[1.054/1] top-0 right-0 absolute'>
                <Image src='/frames/grid-top.png' fill alt='Grid' />
              </div>
              <div className='w-2/5 aspect-[1.054/1] bottom-0 left-0 absolute'>
                <Image src='/frames/grid-bottom.png' fill alt='Grid' />
              </div>
      ...
      <main className='mt-14 bg-white py-20'>
        <div className='max-w-6xl mx-auto'>
          <div className='container mx-auto px-4'>
            ...
            <p className='text-center text-xl text-grey mt-2'>
